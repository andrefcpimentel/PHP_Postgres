/**
* RestPostgres.php: A HTTP REST interface to relational databases
* written in PHP 5+
*
* @author Andre Pimentel
* @category Library
* @package PHP_Postgres
* @version 0.0.1
* @link http://github.com/andrefcpimentel/PHP_Postgres
*
*/
...
class RestPostgres {
    ...
    function getColumns($table) {
    	$qs = sprintf('SELECT * FROM schema.columns WHERE table_name =\'%s\'', $table);
    ...
    function getDatabase() {
        return pg_query('SELECT table_name FROM schema.tables WHERE table_schema=\'public\'');   
    }
